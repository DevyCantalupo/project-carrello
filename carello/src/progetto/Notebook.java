...
public class Notebook implements Article {
    ...
    public Notebook(String manufacturer, String model, String description, double screenSizeInInches, int memory, double priceOfBuying, double priceOfSelling, int id) {
