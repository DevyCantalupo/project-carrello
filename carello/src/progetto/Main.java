...
class Main {
    ...
    public static void productsAlreadyInWarehouse() {
        Article product1 = new Tablet("Susa", "VK64", "Yep, it's a tablet", 10.5, 64, 80, 59.99, GenerateUniqueId.generateUniqueID());
        Warehouse.warehouse.add(product1);
        Article product2 = new Tablet("SpyPhone", "69", "James Bond approves", 2, 2048, 6000, 10000, GenerateUniqueId.generateUniqueID());
        Warehouse.warehouse.add(product2);
        Article product3 = new Smartphone("Big", "Chungus", "It's big", 20, 512, 400, 800, GenerateUniqueId.generateUniqueID());
        Warehouse.warehouse.add(product3);
        Article product4 = new Smartphone("Susa", "Honor", "Good camera", 6, 128, 250, 500, GenerateUniqueId.generateUniqueID());
        Warehouse.warehouse.add(product4);
        Article product5 = new Notebook("SpyPhone", "SlimJim", "We make notebooks too", 13, 4096, 8999, 24999, GenerateUniqueId.generateUniqueID());
        Warehouse.warehouse.add(product5);
        Article product6 = new Notebook("Tencent", "YadMYqRiN", "It's cheap ;)", 14, 32, 0.05, 0.1, GenerateUniqueId.generateUniqueID());
        ...
        Smartphone smartphone1 = new Smartphone("Nokia", "3210", null, 11, 90, 150, 300, GenerateUniqueId.generateUniqueID());
        Warehouse.warehouse.add(smartphone1);
        Smartphone smartphone2 = new Smartphone("Iphone", "12", "Funziona", 31, 120, 150, 400, GenerateUniqueId.generateUniqueID());
        ...
        Notebook notebook2 = new Notebook("Apple", "pro", "vecchio", 22, 400, 300, 800, GenerateUniqueId.generateUniqueID());
